...
Если не хочется включать всё сразу, используй только 5 skills:
...
Начинай с “какая процедура нужна?”
```
